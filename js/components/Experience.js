    ...
    return [
      {
        ...
        description:
          'Lidero el desarrollo de aplicaciones web escalables y arquitecturas de microservicios. Trabajo con equipos ágiles para entregar soluciones innovadoras que impactan a más de 100,000 usuarios.',
        achievements: [
      ...
      },
      {
        ...
        description:
          'Desarrollé aplicaciones web completas desde cero, trabajando tanto en frontend como backend. Participé en todas las fases del ciclo de desarrollo de software.',
        achievements: [
      ...
      },
      {
        ...
        description:
          'Especializado en desarrollo frontend, creé interfaces de usuario atractivas y funcionales para diversos clientes. Trabajé con metodologías ágiles y colaboré estrechamente con diseñadores.',
        achievements: [
      ...
      },
      {
        ...
        description:
          'Inicié mi carrera profesional desarrollando sitios web estáticos y dinámicos. Aprendí las mejores prácticas de desarrollo web y trabajé en proyectos reales para clientes.',
        achievements: [
